...
-- | Pretty-printer for PrintLatteMalinowe.

module PrintLatteMalinowe where
...
instance Print AbsLatteMalinowe.Ident where
  prt _ (AbsLatteMalinowe.Ident i) = doc $ showString i
instance Print (AbsLatteMalinowe.Program' a) where
  prt i = \case
    AbsLatteMalinowe.Program _ topdefs -> prPrec i 0 (concatD [prt 0 topdefs])

instance Print (AbsLatteMalinowe.TopDef' a) where
  prt i = \case
    AbsLatteMalinowe.FnDef _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
...
instance Print (AbsLatteMalinowe.Arg' a) where
  prt i = \case
    AbsLatteMalinowe.Arg _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_])
...
instance Print (AbsLatteMalinowe.Block' a) where
  prt i = \case
    AbsLatteMalinowe.Block _ stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, doc (showString "}")])

instance Print [AbsLatteMalinowe.Stmt' a] where
  prt _ [] = concatD []
  prt _ (x:xs) = concatD [prt 0 x, prt 0 xs]
...
instance Print (AbsLatteMalinowe.Stmt' a) where
  prt i = \case
    ...
    AbsLatteMalinowe.Incr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "++"), doc (showString ";")])
    AbsLatteMalinowe.Decr _ id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "--"), doc (showString ";")])
    AbsLatteMalinowe.Ret _ expr -> prPrec i 0 (concatD [doc (showString "return"), prt 0 expr, doc (showString ";")])
...
instance Print (AbsLatteMalinowe.Item' a) where
  prt i = \case
    AbsLatteMalinowe.NoInit _ id_ -> prPrec i 0 (concatD [prt 0 id_])
    AbsLatteMalinowe.Init _ id_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 expr])
...
instance Print (AbsLatteMalinowe.Type' a) where
  prt i = \case
    ...
    AbsLatteMalinowe.Str _ -> prPrec i 0 (concatD [doc (showString "string")])
    AbsLatteMalinowe.Bool _ -> prPrec i 0 (concatD [doc (showString "bool")])
    AbsLatteMalinowe.Void _ -> prPrec i 0 (concatD [doc (showString "void")])
...
instance Print (AbsLatteMalinowe.AddOp' a) where
  prt i = \case
    AbsLatteMalinowe.Plus _ -> prPrec i 0 (concatD [doc (showString "+")])
    AbsLatteMalinowe.Minus _ -> prPrec i 0 (concatD [doc (showString "-")])

instance Print (AbsLatteMalinowe.MulOp' a) where
  prt i = \case
    AbsLatteMalinowe.Times _ -> prPrec i 0 (concatD [doc (showString "*")])
    AbsLatteMalinowe.Div _ -> prPrec i 0 (concatD [doc (showString "/")])
    AbsLatteMalinowe.Mod _ -> prPrec i 0 (concatD [doc (showString "%")])
